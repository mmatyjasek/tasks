...
public class TrelloControllerTest {
    ...
    public void shouldFetchTrelloBoards() throws Exception {
        ...
        trelloBoards.add(new TrelloBoardDto("Test Board 1", "1", trelloLists));
        when(trelloFacade.fetchTrelloBoards()).thenReturn(trelloBoards);
        mockMvc.perform(get("/v1/trello/getTrelloBoards").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id", is("1")))
                .andExpect(jsonPath("$[0].name", is("Test Board 1")))
    ...
    public void shouldCreateTrelloCard() throws Exception{
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test Card", "Testing", "top", "1");
        ...
        mockMvc.perform(post("/v1/trello/createTrelloCard")
                ...
                .andExpect(jsonPath("$.name", is("Test Card")))
